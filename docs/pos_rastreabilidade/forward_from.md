...
| RF45 |Deve ser possível cadastrar biometria                                              | - | Registrar | -  |
| RF46 |Deve ser possível cadastrar Cpf/Cnpj                                               | US01 | Registrar | -  |
| RF47 |Deve ser possível consultar pontuação de infrações associadas ao condutor          | US18 | Registrar | C06  |
